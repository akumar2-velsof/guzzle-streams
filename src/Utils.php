<?php
namespace GuzzleHttp1\Stream;

use GuzzleHttp1\Stream\Exception\SeekException;
...
class Utils
{
    ...
    /**
     * Alias of GuzzleHttp1\Stream\Stream::factory.
     *
     * @param mixed $resource Resource to create
     * @param array $options  Associative array of stream options defined in
     *                        {@see \GuzzleHttp1\Stream\Stream::__construct}
     *
     * @return StreamInterface
     *
     * @see GuzzleHttp1\Stream\Stream::factory
     * @see GuzzleHttp1\Stream\Stream::__construct
     */
